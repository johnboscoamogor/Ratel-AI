...
const ProfileStudio: React.FC<ProfileStudioProps> = ({ onClose, userProfile, setUserProfile }) => {
    ...
    const handleSave = () => {
        playSound('click');
        setUserProfile(prev => prev ? { ...prev, telegramUsername: telegramUsername.trim() } : null);
    ...
    const getTopInterest = () => {
        ...
        return Object.entries(interests).reduce((a, b) => a[1] > b[1] ? a : b)[0];
    };
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="pt-4 space-y-4 border-t border-gray-200">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 text-right mt-1">XP to next level: {xpForNextLevel - userProfile.xp}</p>
                        </div>
