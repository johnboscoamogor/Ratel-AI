...
async function generateSceneVideo(scene: any, storyTitle: string): Promise<string | null> {
    ...
    // NO DELAY: Return placeholder immediately to prevent timeouts.
    const placeholders = [
...
async function generateNarrationAudio(text: string, language: string): Promise<string> {
    ...
    // NO DELAY: Return placeholder immediately.
    ...
    return "SUQzBAAAAAAB9AMBACABAFRoZSBzaWxlbmNlIGlzIGdvbGRlbgBUU1NFAAAAAA Lavf58.29.";
}
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    const [sceneVideoUrls, audioBase64] = await Promise.all([
        Promise.all(storyJson.scenes.map((scene: any) => generateSceneVideo(scene, storyJson.title))),
        generateNarrationAudio(narrationCombined, language)
    ]);
