    ...
    translation: {
      ...
      "videoStudio": {
          "generating": {
              ...
              "audio": "Synthesizing audio tracks...",
              "final": "Combining audio and video..."
          }
      },
      "storytellerStudio": {
          "title": "Storyteller Studio",
          "promptPlaceholder": "e.g., A story about a brave tortoise who learns to fly.",
          "generateButton": "Create Story",
          "tryExample": "...or try an example",
          "examples": [
              "A folk tale about why the chameleon changes color.",
              "A modern story about a girl in Kigali who builds a robot to help her grandmother.",
              "A funny story about a group of talking animals planning a surprise party in the Serengeti."
          ],
          "loading": {
              "script": "Writing your story script...",
              "video": "Creating video scenes...",
              "audio": "Recording the narration...",
              "final": "Putting it all together..."
          },
          "error": "Story generation failed: {{error}} Please try again.",
          "disclaimer": "This video is generated by AI. The visuals and audio may not be perfect.",
          "downloadAudio": "Download Narration (MP3)",
          "share": "Share to Community",
          "shared": "Shared!",
          "script": "View Script & Assets"
      },
      "videoArStudio": {
          "title": "Video AR Studio",
          "promptPlaceholder": "e.g., add a birthday hat, give me sunglasses",
          ...
          "errorCamera": "Camera access is required for this feature. Please enable it in your browser settings."
      },
      "examplesStudio": {
